...
return new class extends Migration
{
    public function up(): void
    {
        Schema::create('workspaces', function (Blueprint $table) {
            ...
            $table->string('widget_color', 7)->default('#6366f1');
            $table->string('widget_position')->default('bottom-right');
            $table->string('widget_greeting')->default('Hi there! How can we help you today?');
            $table->string('widget_agent_label')->default('Support Team');
            $table->string('widget_avatar')->nullable();
